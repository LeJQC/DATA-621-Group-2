...
First, we will use the skim() function from the skimr package to get a broad overview of the training data. This function provides summary statistics for each column based on the data type.
